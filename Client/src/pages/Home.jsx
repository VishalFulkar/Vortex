...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col p-4 md:p-6 text-black select-none">
      ...
      {/* Notification Toast */}
      {notification && (
        <div className={`fixed top-6 right-6 z-60 px-4 py-3 rounded-2xl shadow-xl flex items-center gap-2 border text-sm font-semibold transition-all ${notification.type === 'error'
